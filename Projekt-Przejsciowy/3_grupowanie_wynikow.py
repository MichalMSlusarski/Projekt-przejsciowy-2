...
# Create a new DataFrame with the top 30 records from grouped_df
top_30_urls = grouped_df.head(30)

top_30_urls.to_csv('top_30_urls.csv', index=False)
print(top_30_urls)