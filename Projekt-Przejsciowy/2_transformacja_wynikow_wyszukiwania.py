...
# Function to extract 'url' and 'position' from the first 30 'organicSearch' results
def extract_data_from_file(file_path):
    ...
    if 'organicResults' in data[0]:
        for result in data[0]['organicResults'][:30]:
            url = result.get('url', '')
...
csv_file_path = "C:\\Users\\mslus\\Desktop\\Projects\\output_2.csv"
